...
const ownerNumber = ['923138406908']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("AKRAM-XD~", '');
...
console.log("CONNECTING AKRAM-DAHRI-MD 🧬...");
...
console.log('AKRAM-DAHRI-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ AKRAM-DAHRI-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb776K584Om6scpVaq2J*
...
//================ownerreact==============
if(senderNumber.includes("923138406908")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("923138406908")){
...
app.get("/", (req, res) => {
res.send("HEY, AKRAM-DAHRI-MD STARTED ✅");
});
